...
import torch
from rpvq_v3.rpvq import RPVQ_V3 as RPVQ
from rpvq_v3.quantizer import NPVectorQuantizer_RPVQV3 as NPVectorQuantizer
...
def layer_quantizer(args, quant_args, layer, layer_idx, logger, dev, dtype):
    ...
    return layer, quantizers, qlinear_args
