...
class AutoModelForCausalLM(transformers.AutoModel):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, auto_conf=None, *args, **kwargs):
        ...
        with transformers.utils.generic.ContextManagers(init_contexts):
            model = cls.from_config(auto_conf, *args, **cls_kwargs).to_empty(device="cuda")
    ...
    def from_pretrained_2(model, pretrained_model_name_or_path, auto_conf=None, *args, **kwargs):
