...
def quant_qwen(model, args, quant_args, dev='cuda'):
    ...
    if 'vptq' in args.vq_type:
        ...
        qmodel = get_quantized_qwen_rpvq(model_name, args.seq_len, layer_state_dicts, layer_qlinear_args)
    else:
        qmodel=model
    model = qmodel
...
def get_quantized_qwen_rpvq(model_name, seqlen, layer_state_dicts, layer_qlinear_args):
